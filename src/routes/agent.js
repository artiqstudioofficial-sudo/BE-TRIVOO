...
Route.get(
  "/products/:id/images",
  requireAuth,
  agentProduct.list_my_product_images
);
Route.post(
  "/products/:id/images",
  requireAuth,
  agentProduct.add_my_product_images
);
Route.put(
  "/products/:id/images/reorder",
  requireAuth,
  agentProduct.reorder_my_product_images
);
Route.put(
  "/products/:id/images/:image_id",
  requireAuth,
  agentProduct.update_my_product_image
);
Route.delete(
  "/products/:id/images/:image_id",
  requireAuth,
  agentProduct.delete_my_product_image
);
